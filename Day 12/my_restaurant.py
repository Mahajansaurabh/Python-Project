...
def total_calculation():
    ...
    food_cost_variable.set(f'$ {round(food_subtotal,2)}')
    drink_cost_variable.set(f'$ {round(drink_subtotal, 2)}')
    dessert_cost_variable.set(f'$ {round(dessert_subtotal, 2)}')
    subtotal_variable.set(f'$ {round(my_subtotal, 2)}')
    taxes_variable.set(f'$ {round(my_taxes, 2)}')
    total_variable.set(f'$ {round(my_total, 2)}')
...
def create_invoice():
    ...
    invoice_text.insert(END, f'*' * 47 + '\n')
    invoice_text.insert(END, f'Food Subtotal: \t\t\t{food_cost_variable.get()}\n')
    invoice_text.insert(END, f'Drink Subtotal: \t\t\t{drink_cost_variable.get()}\n')
    invoice_text.insert(END, f'Dessert Subtotal: \t\t\t{dessert_cost_variable.get()}\n')
    invoice_text.insert(END, f'-' * 54 + '\n')
    invoice_text.insert(END, f'Subtotal: \t\t\t{subtotal_variable.get()}\n')
    invoice_text.insert(END, f'Taxes: \t\t\t{taxes_variable.get()}\n')
    invoice_text.insert(END, f'Total: \t\t\t{total_variable.get()}\n')
    invoice_text.insert(END, f'*' * 47 + '\n')
    invoice_text.insert(END, f'See you again')
...
def reset_all():
    ...
    food_cost_variable.set('')
    drink_cost_variable.set('')
    dessert_cost_variable.set('')
    subtotal_variable.set('')
    taxes_variable.set('')
    total_variable.set('')
...
#Window size
application.geometry('2560x1664+0+0')
...
#Variables
food_cost_variable = StringVar()
drink_cost_variable = StringVar()
dessert_cost_variable = StringVar()
subtotal_variable = StringVar()
taxes_variable = StringVar()
total_variable = StringVar()
...
food_cost_text = Entry(cost_panel,
                       ...
                       width= 10,
                       state= 'readonly',
                       textvariable= food_cost_variable)
...
drink_cost_text = Entry(cost_panel,
                       ...
                       width= 10,
                       state= 'readonly',
                       textvariable= drink_cost_variable)
...
dessert_cost_text = Entry(cost_panel,
                       ...
                       width= 10,
                       state= 'readonly',
                       textvariable= dessert_cost_variable)
...
subtotal_cost_text = Entry(cost_panel,
                       ...
                       width= 10,
                       state= 'readonly',
                       textvariable= subtotal_variable)
